...
import { Home, ListMusic, BarChart2, Settings, LogOut, Menu, BookOpen, LayoutDashboard, Users } from 'lucide-react'; // Added Users icon for Clients
...
const navItems = [
  ...
  { name: 'Clientes', path: '/clients', icon: Users }, // Added 'Clientes' item
