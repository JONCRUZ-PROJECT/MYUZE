...
import { Home, ListMusic, BarChart2, Settings, LogOut, Menu, BookOpen, LayoutDashboard, Store } from 'lucide-react'; // Added Store icon
...
const navItems = [
  ...
  { name: 'Instalações', path: '/installations', icon: Store }, // Reintroduced 'Instalações' item
