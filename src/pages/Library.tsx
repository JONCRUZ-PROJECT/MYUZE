...
const Library = () => {
  ...
  const handleVoiceoverFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.files && event.target.files[0]) {
      ...
      // For now, a placeholder or actual audio duration if possible
    ...
    <div className="space-y-8 text-myuze-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="bg-myuze-gray-translucent text-myuze-white border-none shadow-xl backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-2xl font-semibold flex items-center">
              <Music className="mr-2 h-6 w-6 text-myuze-purple" /> Músicas
            </CardTitle>
            <CardDescription className="text-gray-300">Gerencie e faça upload de suas músicas.</CardDescription>
          </CardHeader>
        ...
        <Card className="bg-myuze-gray-translucent text-myuze-white border-none shadow-xl backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-2xl font-semibold flex items-center">
              <Mic className="mr-2 h-6 w-6 text-myuze-purple" /> Locuções
            </CardTitle>
